(function () {
  var CONFIG = {
    clientId: "Ov23liqY8t6gGuHHJ6xZ",
    clientSecret: "ba413223aa56eeea5f4eedcebd8828653382a4e4",
    allowedUsers: ["octocat"],
    loginUrl: "https://nxtcloud-org.github.io/nxt-team-blog/login/",
  ...
  var isLoginPage =
    path === "/nxt-team-blog/login/" ||
    path === "/nxt-team-blog/login/".replace(/\/$/, "");
  var isAdminPage = path.indexOf("/nxt-team-blog/admin") === 0;
